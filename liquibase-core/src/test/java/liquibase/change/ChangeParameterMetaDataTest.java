...
public class ChangeParameterMetaDataTest {
    ...
    public void computedDatabasesCorrect(){
        ...
        assertSetsEqual(new String[]{"sybase","mssql","vertica","postgresql","firebird","oracle","sqlite","mysql","h2"}, replaceIfExists.analyzeSupportedDatabases(new String[]{ChangeParameterMetaData.COMPUTE}));
    }
